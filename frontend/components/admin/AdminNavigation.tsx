...
const navItems: NavItem[] = [
  { href: '/admin', label: 'Обзор', icon: '/icons/trophy-icon.png' },
  { href: '/admin/users', label: 'Пользователи', icon: '/icons/user-icon.png' },
  { href: '/admin/teams', label: 'Команды', icon: '/icons/group-icon.png' },
  { href: '/admin/statistics', label: 'Статистика', icon: '/icons/task-list-icon.png' },
]
...
export default function AdminNavigation({ isMobile = false, onNavigate }: AdminNavigationProps) {
